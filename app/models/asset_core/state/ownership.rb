module AssetCore
  class State::Ownership < AssetCore::State
    ...
    class Attributes < ::AssetCore::Attributes
      ...
      attribute :counterparty_address, :string
      attribute :counterparty_contact, :string

    end

    custom_attributes_definition :data, ::AssetCore::State::Ownership::Attributes, accessor: true
    ...
    self.states_list = [
      ...
      { name: "custody_in",   label: "Custody in",   owned: false },
